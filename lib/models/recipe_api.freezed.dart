...
mixin _$RecipeApi {
 ...
 int get id; String get title; String get image; int get usedIngredientCount; int get missedIngredientCount;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is RecipeApi&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title)&&(identical(other.image, image) || other.image == image)&&(identical(other.usedIngredientCount, usedIngredientCount) || other.usedIngredientCount == usedIngredientCount)&&(identical(other.missedIngredientCount, missedIngredientCount) || other.missedIngredientCount == missedIngredientCount));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,title,image,usedIngredientCount,missedIngredientCount);

@override
String toString() {
  return 'RecipeApi(id: $id, title: $title, image: $image, usedIngredientCount: $usedIngredientCount, missedIngredientCount: $missedIngredientCount)';
}
...
@useResult
$Res call({
 int id, String title, String image, int usedIngredientCount, int missedIngredientCount
});
...
/// Create a copy of RecipeApi
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,Object? image = null,Object? usedIngredientCount = null,Object? missedIngredientCount = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  String title,  String image,  int usedIngredientCount,  int missedIngredientCount)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _RecipeApi() when $default != null:
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  String title,  String image,  int usedIngredientCount,  int missedIngredientCount)?  $default,) {final _that = this;
switch (_that) {
case _RecipeApi() when $default != null:
return $default(_that.id,_that.title,_that.image,_that.usedIngredientCount,_that.missedIngredientCount);case _:
  return null;
...
/// Create a copy of RecipeApi
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? title = null,Object? image = null,Object? usedIngredientCount = null,Object? missedIngredientCount = null,}) {
